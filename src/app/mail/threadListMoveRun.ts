...
function optimisticRemoveThreadFromList(threadId: string): ThreadListRollback {
...
function rollbackThreadListChange(threadId: string, prev: ThreadListRollback): void {
