...
- Package version in `package.json`, `src-tauri/tauri.conf.json`, and workspace `Cargo.toml` (currently `0.2.0`)
- Tag format: `v0.2.0` (must match release workflow pattern)
